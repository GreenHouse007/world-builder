    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    dbName = process.env.MONGO_DB || "enfield";
                    db = client.db(dbName);
                    collections = {
                        Worlds: db.collection("worlds"),
                        Pages: db.collection("pages"),
                        PageContent: db.collection("page_content"),
                        Favorites: db.collection("favorites"),
                        WorldActivity: db.collection("world_activity"),
                        WorldInvitations: db.collection("world_invitations"),
                    };
