...
function initFirebase() {
    ...
    if (key) {
        try {
            ...
            console.log("[auth] Initialized Firebase Admin with FIREBASE_SERVICE_ACCOUNT_KEY");
            return;
        }
        catch (err) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, auth_1.getAuth)().verifyIdToken(token)];
                case 2: return [2 /*return*/, _a.sent()];
                case 3:
                    err_1 = _a.sent();
                    console.error("verifyBearer error", err_1);
                    return [2 /*return*/, null];
